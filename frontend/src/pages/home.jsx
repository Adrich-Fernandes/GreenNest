      ...
      <section ref={heroRef} className="min-h-screen bg-white flex items-center px-6 md:px-16 py-16">
        <div className="max-w-7xl mx-auto w-full flex flex-col md:flex-row gap-10 items-center">
          ...
          <div className="flex flex-col gap-6 items-center text-center md:items-start md:text-left w-full md:w-1/2">
            ...
            <div className={`inline-flex items-center gap-2 bg-white border border-green-100 text-green-700 text-sm font-medium px-4 py-1.5 rounded-full w-fit shadow-sm transition-all duration-700 ${heroInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
            ...
            <div className={`transition-all duration-700 ${heroInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
              ...
              <h1 className="text-5xl md:text-6xl font-black text-green-600 leading-tight tracking-tight">Closer to Home</h1>
            </div>

            <p className={`text-gray-500 text-base md:text-lg leading-relaxed max-w-md transition-all duration-700 ${heroInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
            ...
            <div className={`flex items-center justify-center md:justify-start gap-3 flex-wrap transition-all duration-700 ${heroInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
              style={{ transitionDelay: "400ms" }}>
              <button className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-150 hover:scale-105 active:scale-95">
                Browse Plants <ArrowRight className="w-4 h-4" />
              </button>
              <button className="border border-gray-300 hover:border-gray-400 text-gray-700 font-semibold px-6 py-3 rounded-xl bg-white transition-all duration-150 hover:scale-105 active:scale-95">
                Find a Gardener
              </button>
            </div>

            <div className={`flex items-center justify-center md:justify-start gap-6 mt-2 transition-all duration-700 ${heroInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
          ...
          {/* RIGHT */}
          <div className={`hidden md:flex relative w-full md:w-1/2 justify-center items-center transition-all duration-1000 ${heroInView ? "opacity-100 translate-x-0" : "opacity-0 translate-x-12"}`}
            style={{ transitionDelay: "300ms" }}>
            <div
            ...
            <div className={`absolute -bottom-5 -left-6 bg-white rounded-2xl shadow-lg px-5 py-3.5 flex items-center gap-3 z-20 transition-all duration-700 ${heroInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 pb-10">
            ...
            <div className="flex flex-col gap-4">
              ...
              <ul className="flex flex-col gap-3">
                <li><Link to="mailto:help@greennest.com" className="text-green-300 text-sm hover:text-white transition-colors duration-150">help@greennest.com</Link></li>
                <li><Link to="tel:+15551234567" className="text-green-300 text-sm hover:text-white transition-colors duration-150">+1 (555) 123-4567</Link></li>
              </ul>
            </div>
          </div>
          <div className="border-t border-green-800/60" />
          <div className="pt-6 text-center">
            <p className="text-green-400 text-sm">© 2026 GreenNest. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </>
          ...
          {categories.map((cat, i) => {
            ...
            return (
              <Link
                to="/plants"
                key={cat.label}
                className={`group flex flex-col items-center gap-4 p-5 bg-white border border-gray-100 rounded-2xl cursor-pointer shadow-sm hover:shadow-md hover:-translate-y-1 hover:border-green-100 transition-all duration-300 ease-in-out ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
...
function FreshArrivals() {
  const [ref, inView] = useInView();
  return (
    <section ref={ref} className="w-full py-16 px-6 md:px-16">
      <div className="max-w-7xl mx-auto">
        <div className={`flex items-start justify-between mb-8 transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          ...
          <Link to="/plants" className="flex items-center gap-1 text-green-600 hover:text-green-700 text-sm font-semibold transition-colors">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5">
          {products.map((product, i) => (
            ...
            >
              <div className="relative w-full h-52 bg-green-50 overflow-hidden">
                <img
                  src={product.image}
                  alt={product.name}
              ...
              <div className="px-4 pt-4 pb-5 flex flex-col gap-2">
                ...
                <div className="flex items-center justify-between mt-1">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 bg-green-600 hover:bg-green-700 text-white text-sm font-semibold px-4 py-2 rounded-xl transition-all duration-150 hover:scale-105 active:scale-95"
                  >
...
function GardeningServices() {
  const [ref, inView] = useInView();
  return (
    <section ref={ref} className="w-full py-20 px-6 md:px-16 bg-gradient-to-br from-green-950 via-green-900 to-green-950">
      <div className="max-w-7xl mx-auto flex flex-col items-center gap-12">
        <div className={`text-center flex flex-col gap-3 transition-all duration-700 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          ...
          <p className="text-green-200 text-sm md:text-base max-w-lg mx-auto leading-relaxed">
          ...
          {services.map((service, i) => {
            ...
            return (
              <Link
                to="/gardeners"
                key={service.id}
                className={`bg-green-900/60 border border-green-800/40 rounded-2xl px-7 py-8 flex flex-col gap-5 hover:bg-green-800/60 hover:border-green-700/50 hover:-translate-y-1 transition-all duration-300 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-green-200 text-sm leading-relaxed">{service.description}</p>
                </div>
              </Link>
            );
          })}
        ...
        <Link
          to="/gardeners"
          className={`flex items-center gap-2 bg-white hover:bg-gray-50 text-gray-900 font-semibold px-8 py-4 rounded-2xl transition-all duration-300 shadow-md hover:scale-105 active:scale-95 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
          style={{ transitionDelay: "400ms" }}
        >
